...
public class Lesson2 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("сумма переменных a и и = " + (a + b));
        System.out.println("сумма переменных a и и = " + sumAB);

        // Арефметическое сложение
        ...
        System.out.println(a + b + " " + a + b); // до строки происходит арифметическое выражение, после строка // 18 513
